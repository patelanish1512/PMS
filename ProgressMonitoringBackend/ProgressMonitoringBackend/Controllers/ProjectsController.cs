...
public class ProjectsController : ControllerBase
{
    ...
    private readonly ProgressMonitoringBackend.Infrastructure.Mongo.MongoDbContext _context;

    public ProjectsController(IProjectService projectService, ProgressMonitoringBackend.Infrastructure.Mongo.MongoDbContext context)
    {
    ...
    [HttpPost]
    [RequirePermission("projects", "CanCreate")]
    ...
    [HttpPut("{id}")]
    [RequirePermission("projects", "CanEdit")]
    public async Task<ActionResult<ProjectDto>> UpdateProject(string id, ProjectDto projectDto)
    {
        ...
        var update = Builders<ProgressMonitoringBackend.Domain.Entities.Project>.Update
        ...
        {
            if (Enum.TryParse<ProgressMonitoringBackend.Domain.Enums.ProjectStatus>(projectDto.Status, true, out var status))
    ...
    [HttpDelete("{id}")]
    [RequirePermission("projects", "CanDelete")]
