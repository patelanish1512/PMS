...
using System.Linq;
using System;
using TaskStatus = ProgressMonitoringBackend.Domain.Enums.TaskStatus;
...
public class ReportsController : ControllerBase
{
    ...
    [HttpGet("stats")]
    [HttpGet("summary")]
    [RequirePermission("reports", "CanView")]
    public async Task<ActionResult<object>> GetStats()
    {
        ...
        var stats = new
        {
            ...
            ActiveProjects = projects.Count(p => p.Status == ProgressMonitoringBackend.Domain.Enums.ProjectStatus.Active),
            CompletedProjects = projects.Count(p => p.Status == ProgressMonitoringBackend.Domain.Enums.ProjectStatus.Completed),
    ...
    public async Task<ActionResult<List<object>>> GetRecentReports()
    {
        ...
        var reports = new List<object>
        {
            new {
                ...
                Size = "2.4 MB",
                Status = "ready",
                Summary = $"{projects.Count} total projects, {projects.Count(p => p.Status == ProgressMonitoringBackend.Domain.Enums.ProjectStatus.Active)} active"
            },
            new {
                Id = "task-summary",
