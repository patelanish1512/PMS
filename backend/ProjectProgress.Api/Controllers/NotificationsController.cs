...
public class NotificationsController : ControllerBase
{
    ...
    public async Task<ActionResult<List<NotificationDto>>> GetAll()
    {
        ...
        FilterDefinition<Domain.Entities.NotificationItem> filter;
        
        if (User.IsInRole("Admin"))
            filter = Builders<Domain.Entities.NotificationItem>.Filter.Empty;
        else
            filter = Builders<Domain.Entities.NotificationItem>.Filter.Eq(n => n.UserId, userId);
    ...
    {
        var update = Builders<Domain.Entities.NotificationItem>.Update.Set(n => n.IsRead, true);
    ...
    private static NotificationDto MapToDto(Domain.Entities.NotificationItem n) => new()
    {
        Id = n.Id,
        Type = n.Type,
        Title = n.Title,
